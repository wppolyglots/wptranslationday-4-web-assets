...
*
* GET WP TRANSLATIONS
* Get data from https://api.wordpress.org/translations/core/1.0/?version=5.2
* @return $array_top120 array, with :
...
function gwtd3_get_wp_translations() {
	...
	// If the transient does NOT EXISTS so let's get the remote data
		...
		$response = wp_remote_get( 'https://api.wordpress.org/translations/core/1.0/?version=5.2' );
